...
const sendLowStockAlert = async (productName, currentStock) => {
    try {
        ...
        const subject = settings.alert_subject.replace('{producto}', productName);
        const message = settings.alert_message
            .replace('{producto}', productName)
            .replace('{stock}', currentStock);

        // Ruta de la imagen (puedes cambiarla a la que quieras)
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p style="color: #374151; line-height: 1.6;">
                <strong>Acción recomendada:</strong> Por favor, revise el inventario y considere realizar un nuevo pedido para evitar quedarse sin stock.
            </p>
        </div>
